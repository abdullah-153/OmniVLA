...
def run_planner_chat(message, chat_history=None, rag_context="", user_profile_context="", activity_callback=None,
                     learn_personal_context=True, tool_result_callback=None, cancel_event=None,
                     context_receipt_callback=None):
    import cogniagent.gui.server_manager as sm
    ...
    return sm.run_planner_chat(message, history, temp, max_tokens, rag_context,
                               ...
                               tool_result_callback=tool_result_callback, cancel_event=cancel_event,
                               context_receipt_callback=context_receipt_callback)
